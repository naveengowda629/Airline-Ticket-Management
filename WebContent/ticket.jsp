...
<h1 class="agile_head text-center">Your e-Ticket</h1> </center>
  ...
  <div class="container">
   ...
   <img src='images/barcode.png' width='200' height='50'/> <h2><%=bean.getFlightName().toUpperCase() %></h2>
   <table  width='100%'>
   <tr>
   ...
   <tr>
   <td><%=bean.getPname().toUpperCase() %></td>
   <td><%=bean.getDate() %></td>
   <td ><%=tripId %></td>
   </tr>
   <tr>
   ...
   <tr>
   <td><%=bean.getFrom1().toUpperCase()%></td>
